...
<form method="post">
	<nav class="navbar navbar-expand-lg navbar-light fixed-top">
		<div class="container">
			<h2 class="navbar-brand" href="adminhome.jsp" style="color: rgb(255, 255, 255);">car</h2> 
			<h2 class="navbar-brand" href="adminhome.jsp" style="color: rgb(60, 124, 243);">guru</h2> 
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ml-auto">
					<!-- <li class="nav-item active">
						<a class="nav-link" href="adminhome.jsp" style="color: rgb(241, 155, 42);">Home</a>
					</li> -->
					<li class="nav-item">
						<a class="nav-link" href="adminabout.jsp">About</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="admincars.jsp">CARS</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="users.jsp">users</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="allbookings.jsp">users Bookings</a>
					
                    <li class="nav-item">
                    <a class="nav-link" href="adminprofile.jsp" style="color: rgb(241, 155, 42);">
                    <%   
