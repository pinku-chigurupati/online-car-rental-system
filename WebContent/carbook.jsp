    ...
    <div class="row d-flex justify-content-center pb-5">
        <div class="col-sm-5 col-md-5 ml-1">
            ...
            <div class="pt-2">
                ...
                <h6><a class="fa fa-plus-circle text-primary text-primary" href="addcard.jsp">Add Card</a></h6>
            </div>
                </div>
                ...
                <div> <input formaction="success2.jsp" type="submit" value="Proceed to payment" class="btn btn-primary btn-block"> </div>
            </div>
        </div>
