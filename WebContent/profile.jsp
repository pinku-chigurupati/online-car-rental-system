<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 import="java.sql.*,javax.servlet.*,java.io.*"   pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html>
<head>
...
<nav class="navbar navbar-expand-md navbar-light bg-light">
				...
				<div class="collapse navbar-collapse" id="navbarCollapse">
					...
					<div class="navbar-nav ml-auto">
						<a href="logout.jsp" class="nav-item nav-link" style="font-weight: 500;">
...
if(rs.next())
{
	...
	String image=(String)ses.getAttribute("image");
                    ...
                    <div class="col-md-6">
                        <div class="profile-head">
                                    <h5>
                                        ...
                                        out.println((String)ses.getAttribute("firstname")); %>
                                    </h5>
                                     <h6>
                                        Gold member
                                    </h6> 
                                     <p class="proile-rating">Reputation Points : <span>0</span></p> 
                    ...
                    <div class="col-md-8">
                        <div class="tab-content profile-tab" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        ...
                                        out.println((String)ses.getAttribute("username")); %></p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                        ...
                                        out.println((String)ses.getAttribute("firstname")); %></p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                        ...
                                        out.println((String)ses.getAttribute("gmail")); %></p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                        ...
                                        out.println((String)ses.getAttribute("phone")); %></p>
                                            </div>
                                        </div>
                                        <div class="row">
                                             <div class="col-md-6">
                                        ...
                                        out.println((String)ses.getAttribute("type")); %></p>
                                            </div>  
                                        </div>
                            </div>
