...
<body  method="post" action="delete.jsp">
 ...
 <nav class="navbar navbar-expand-md navbar-light bg-light">
    ...
    <div method="post" class="registration-form">
        <form method="post" >
            ...
            <div method="post"  class="form-group">
                <button formaction="delete.jsp" id="re" type="submit" class="btn btn-block create-account">Delete Car</button>
            </div>
        </form>
