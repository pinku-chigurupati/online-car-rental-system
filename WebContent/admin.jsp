...
con = DriverManager.getConnection("jdbc:mysql://localhost:3306/eppro","root","Pinku@2001");
		...
		<p><% out.println(rs.getString("millage")); %> kmpl &#8226;1197 <% out.println(rs.getString("cc")); %> &#8226;<% out.println(rs.getString("type")); %></p>
		
		<p><button >View</button></p>
		
		<p><button formaction="delete.jsp" id="<% out.println(rs.getString("name")); %>" name="<% out.println(rs.getString("name")); %>">delete</button></p>
	  </div>
